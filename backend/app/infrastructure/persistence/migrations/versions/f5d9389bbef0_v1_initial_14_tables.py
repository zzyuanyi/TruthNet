...
def upgrade() -> None:
    ...
    op.create_table('companies',
        sa.Column('entity_id', sa.String(64), nullable=False, comment='内部稳定实体 ID'),
        sa.Column('wind_code', sa.String(32), nullable=False, comment='Wind 代码，如 600519.SH'),
        sa.Column('sec_name', sa.String(128), nullable=False, comment='证券简称'),
        sa.Column('aliases', sa.JSON(), nullable=True, comment='曾用名和别名'),
        sa.Column('exchange_code', sa.String(16), nullable=True, comment='交易所代码: XSHG/XSHE'),
        ...
        sa.Column('comp_type_code', sa.SmallInteger(), nullable=True, comment='公司类型'),
        sa.Column('listing_date', sa.Date(), nullable=True, comment='上市日期'),
        sa.Column('industry_source', sa.String(64), nullable=True, comment='行业分类来源'),
        sa.Column('industry_as_of', sa.Date(), nullable=True, comment='行业分类有效日期'),
        # 系统字段
        sa.Column('source_record_id', sa.String(256), nullable=True, comment='原始记录 ID'),
        ...
        sa.Column('dataset_version', sa.String(64), nullable=True, comment='数据集版本'),
        ...
        sa.Column('ingested_at', sa.DateTime(timezone=True), nullable=False, comment='入库时间'),
        ...
        sa.Column('checksum', sa.String(128), nullable=True, comment='记录校验和 (SHA-256)'),
        sa.PrimaryKeyConstraint('entity_id'))
    op.create_index(op.f('ix_companies_wind_code'), 'companies', ['wind_code'], unique=True)
    ...
    op.create_table('balance_sheet',
        ...
        sa.Column('report_period', sa.String(10), nullable=False, comment='报告期 (YYYY-MM-DD)'),
        sa.Column('statement_type', sa.String(32), nullable=False, comment='报表类型代码'),
        sa.Column('ann_dt', sa.String(10), nullable=True, comment='公告日期 (YYYY-MM-DD)'),
        ...
        sa.Column('tot_shrhldr_eqy_incl_min_int', sa.Float(), nullable=True, comment='所有者权益合计（含少数股东权益）'),
        # 系统字段
        sa.Column('source_record_id', sa.String(256), nullable=True, comment='原始记录 ID'),
        sa.Column('source_file', sa.String(512), nullable=True, comment='来源文件名'),
        sa.Column('source_row', sa.Integer(), nullable=True, comment='来源行号'),
        ...
        sa.UniqueConstraint('wind_code', 'report_period', 'statement_type', 'ann_dt', 'revision_no', name='uq_bs_report'))
    op.create_index(op.f('ix_balance_sheet_report_period'), 'balance_sheet', ['report_period'], unique=False)
    op.create_index(op.f('ix_balance_sheet_wind_code'), 'balance_sheet', ['wind_code'], unique=False)
    ...
    op.create_table('income_statement',
        ...
        sa.Column('less_selling_dist_exp', sa.Float(), nullable=True, comment='销售费用'),
        ...
        sa.Column('net_profit_excl_min_int_inc', sa.Float(), nullable=True, comment='净利润（不含少数股东损益）'),
        sa.Column('net_profit_after_ded_nr_lp', sa.Float(), nullable=True, comment='归母净利润'),
        # 系统字段
        sa.Column('source_record_id', sa.String(256), nullable=True, comment='原始记录 ID'),
        sa.Column('source_file', sa.String(512), nullable=True, comment='来源文件名'),
        sa.Column('source_row', sa.Integer(), nullable=True, comment='来源行号'),
        ...
        sa.Column('checksum', sa.String(128), nullable=True, comment='记录校验和 (SHA-256)'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('wind_code', 'report_period', 'statement_type', 'ann_dt', 'revision_no', name='uq_is_report'))
    op.create_index(op.f('ix_income_statement_report_period'), 'income_statement', ['report_period'], unique=False)
    op.create_index(op.f('ix_income_statement_wind_code'), 'income_statement', ['wind_code'], unique=False)
    ...
    op.create_table('cash_flow',
        ...
        sa.Column('statement_type', sa.String(32), nullable=False, comment='报表类型代码'),
        sa.Column('ann_dt', sa.String(10), nullable=True, comment='公告日期'),
        sa.Column('net_cash_flows_oper_act', sa.Float(), nullable=True, comment='经营活动现金流量净额'),
        sa.Column('net_cash_flows_inv_act', sa.Float(), nullable=True, comment='投资活动现金流量净额'),
        sa.Column('net_cash_flows_fnc_act', sa.Float(), nullable=True, comment='筹资活动现金流量净额'),
        sa.Column('net_incr_cash_cash_equ', sa.Float(), nullable=True, comment='现金及等价物净增加额'),
        ...
        sa.Column('checksum', sa.String(128), nullable=True, comment='记录校验和 (SHA-256)'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('wind_code', 'report_period', 'statement_type', 'ann_dt', 'revision_no', name='uq_cf_report'))
    op.create_index(op.f('ix_cash_flow_report_period'), 'cash_flow', ['report_period'], unique=False)
    op.create_index(op.f('ix_cash_flow_wind_code'), 'cash_flow', ['wind_code'], unique=False)

    # ------------------------------------------------------------------
    # 核心表 5: top_shareholders (§10.5)
    # ------------------------------------------------------------------
    op.create_table('top_shareholders',
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('wind_code', sa.String(32), nullable=False, comment='Wind 代码'),
        sa.Column('ann_dt', sa.String(10), nullable=True, comment='公告日期'),
        sa.Column('s_holder_enddate', sa.String(10), nullable=True, comment='股东持股截止日期'),
        sa.Column('s_holder_name', sa.String(256), nullable=False, comment='股东名称'),
        sa.Column('s_holder_aname', sa.String(256), nullable=True, comment='股东别名（用于实体对齐）'),
        ...
        sa.Column('s_holder_holdercategory', sa.String(64), nullable=True, comment='股东类别'),
        ...
        sa.Column('holder_entity_id', sa.String(64), nullable=True, comment='股东实体 ID（与 companies.entity_id 对齐）'),
        sa.Column('entity_match_confidence', sa.Float(), nullable=True, comment='实体对齐置信度 (0-1)'),
        # 系统字段
        sa.Column('source_record_id', sa.String(256), nullable=True, comment='原始记录 ID'),
        sa.Column('source_file', sa.String(512), nullable=True, comment='来源文件名'),
        sa.Column('source_row', sa.Integer(), nullable=True, comment='来源行号'),
        ...
        sa.Column('checksum', sa.String(128), nullable=True, comment='记录校验和 (SHA-256)'),
        sa.PrimaryKeyConstraint('id'))
    op.create_index(op.f('ix_top_shareholders_holder_entity_id'), 'top_shareholders', ['holder_entity_id'], unique=False)
    op.create_index(op.f('ix_top_shareholders_wind_code'), 'top_shareholders', ['wind_code'], unique=False)
    ...
    op.create_table('announcements',
        ...
        sa.Column('n_info_fcode', sa.String(64), nullable=True, comment='公告类型代码（共 33 类）'),
        sa.Column('sentiment', sa.String(16), nullable=True, comment='情感: positive/negative/neutral'),
        sa.Column('sentiment_method', sa.String(32), nullable=True, comment='情感分析方法'),
        sa.Column('source_uri', sa.String(1024), nullable=True, comment='来源 URI'),
        sa.Column('content_hash', sa.String(128), nullable=True, comment='内容哈希 (SHA-256)'),
        # 系统字段
        sa.Column('source_record_id', sa.String(256), nullable=True, comment='原始记录 ID'),
        sa.Column('source_file', sa.String(512), nullable=True, comment='来源文件名'),
        sa.Column('source_row', sa.Integer(), nullable=True, comment='来源行号'),
    ...
    op.create_index(op.f('ix_announcements_wind_code'), 'announcements', ['wind_code'], unique=False)
    ...
    op.create_table('research_reports',
        ...
        sa.Column('rating_change', sa.String(16), nullable=True, comment='评级变化: up/down/maintain'),
        sa.Column('industry_l1', sa.String(64), nullable=True, comment='申万一级行业'),
        sa.Column('sw_indu_code', sa.String(32), nullable=True, comment='申万行业代码'),
        sa.Column('source_uri', sa.String(1024), nullable=True, comment='来源 URI'),
    ...
    op.create_index(op.f('ix_research_reports_wind_code'), 'research_reports', ['wind_code'], unique=False)
    ...
    op.create_table('conversation_sessions',
        ...
        sa.Column('status', sa.String(16), nullable=False, comment='状态: active/archived/closed'),
    ...
    op.create_table('rule_definitions',
        ...
        sa.Column('category', sa.String(64), nullable=False, comment='规则类别 (如 revenue_quality)'),
        ...
        sa.Column('severity', sa.String(16), nullable=False, comment='默认严重程度: low/medium/high/critical'),
    ...
    op.create_table('rule_evaluations',
        ...
        sa.Column('result', sa.String(16), nullable=True, comment='结果: triggered/normal/insufficient_data'),
        sa.Column('score', sa.Float(), nullable=True, comment='评分 (0-1)'),
        sa.Column('detail', sa.JSON(), nullable=True, comment='评估详情 (JSON)'),
        sa.Column('evaluated_at', sa.DateTime(timezone=True), nullable=False, comment='评估时间'),
        sa.Column('rule_version', sa.String(32), nullable=False, comment='使用的规则版本'),
        sa.ForeignKeyConstraint(['rule_id'], ['rule_definitions.rule_id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'))
    op.create_index(op.f('ix_rule_evaluations_rule_id'), 'rule_evaluations', ['rule_id'], unique=False)
    op.create_index(op.f('ix_rule_evaluations_wind_code'), 'rule_evaluations', ['wind_code'], unique=False)
    ...
    op.create_table('evidence_refs',
        ...
        sa.Column('source_type', sa.String(32), nullable=False, comment='证据类型: financial_statement/ownership_record/news_article/regulation'),
        sa.Column('source_record_id', sa.String(256), nullable=False, comment='来源记录 ID'),
        ...
        sa.Column('statement_scope', sa.String(32), nullable=True, comment='报表口径: parent_company/consolidated'),
        ...
        sa.Column('retrieval_score', sa.Float(), nullable=True, comment='检索相关性分数'),
        sa.Column('dataset_version', sa.String(64), nullable=False, comment='数据集版本'),
    ...
    op.create_table('claims',
        ...
        sa.Column('claim_type', sa.String(32), nullable=True, comment='声明类型: fact/analysis/suggestion'),
        sa.Column('severity', sa.String(16), nullable=False, comment='严重程度: none/low/medium/high/critical'),
        sa.Column('confidence', sa.String(16), nullable=True, comment='置信度: high/medium/low/unverified'),
        ...
        sa.Column('verification_status', sa.String(16), nullable=False, comment='验证状态: pending/verified/refuted'),
    ...
    op.create_table('risk_assessments',
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('assessment_id', sa.String(64), nullable=False, comment='评估唯一 ID'),
        sa.Column('wind_code', sa.String(32), nullable=False, comment='Wind 代码'),
        ...
        sa.Column('level', sa.String(16), nullable=False, comment='风险等级: none/low/medium/high/critical'),
        sa.Column('risk_factors', sa.JSON(), nullable=True, comment='风险因子详情 (JSON)'),
        sa.Column('rule_version', sa.String(32), nullable=False, comment='使用的规则版本'),
        sa.Column('dataset_version', sa.String(64), nullable=False, comment='使用的数据版本'),
        sa.Column('assessed_at', sa.DateTime(timezone=True), nullable=False, comment='评估时间'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('assessment_id'))
    op.create_index(op.f('ix_risk_assessments_wind_code'), 'risk_assessments', ['wind_code'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_top_shareholders_holder_entity_id'), table_name='top_shareholders')
    ...
    op.drop_index(op.f('ix_income_statement_report_period'), table_name='income_statement')
