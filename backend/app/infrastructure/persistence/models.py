...
class SystemFieldsMixin:
    ...
    is_latest: Mapped[bool] = mapped_column(Boolean, default=True, comment="是否最新修订")
    ingested_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), default=_utcnow, comment="入库时间"
    )
    updated_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), default=_utcnow, onupdate=_utcnow, comment="最后更新时间"
    )
...
class Company(Base):
    ...
    sec_name: Mapped[str] = mapped_column(String(128), nullable=False, comment="证券简称")
    aliases: Mapped[dict | None] = mapped_column(JSON, nullable=True, comment="曾用名和别名")
    exchange_code: Mapped[str | None] = mapped_column(
        String(16), nullable=True, comment="交易所代码: XSHG/XSHE"
    )
    industry_l1: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="申万一级行业")
    industry_l2: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="申万二级行业")
    sw_indu_code: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="申万行业代码")
    comp_type_code: Mapped[int | None] = mapped_column(SmallInteger, nullable=True, comment="公司类型")
    listing_date: Mapped[datetime | None] = mapped_column(Date, nullable=True, comment="上市日期")
    industry_source: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="行业分类来源")
    industry_as_of: Mapped[datetime | None] = mapped_column(Date, nullable=True, comment="行业分类有效日期")
...
class BalanceSheet(Base, SystemFieldsMixin):
    ...
    monetary_cap: Mapped[float | None] = mapped_column(Float, nullable=True, comment="货币资金")
    acct_rcv: Mapped[float | None] = mapped_column(Float, nullable=True, comment="应收账款")
    oth_rcv: Mapped[float | None] = mapped_column(Float, nullable=True, comment="其他应收款")
    inventories: Mapped[float | None] = mapped_column(Float, nullable=True, comment="存货")
    tot_cur_assets: Mapped[float | None] = mapped_column(Float, nullable=True, comment="流动资产合计")
    ...
    tot_assets: Mapped[float | None] = mapped_column(Float, nullable=True, comment="资产总计")
    st_borrow: Mapped[float | None] = mapped_column(Float, nullable=True, comment="短期借款")
    lt_borrow: Mapped[float | None] = mapped_column(Float, nullable=True, comment="长期借款")
    acct_payable: Mapped[float | None] = mapped_column(Float, nullable=True, comment="应付账款")
    tot_cur_liab: Mapped[float | None] = mapped_column(Float, nullable=True, comment="流动负债合计")
    tot_liab: Mapped[float | None] = mapped_column(Float, nullable=True, comment="负债合计")
...
class IncomeStatement(Base, SystemFieldsMixin):
    ...
    ann_dt: Mapped[str | None] = mapped_column(String(10), nullable=True, comment="公告日期")
    oper_rev: Mapped[float | None] = mapped_column(Float, nullable=True, comment="营业收入")
    tot_oper_rev: Mapped[float | None] = mapped_column(Float, nullable=True, comment="营业总收入")
    less_oper_cost: Mapped[float | None] = mapped_column(Float, nullable=True, comment="营业成本")
    less_selling_dist_exp: Mapped[float | None] = mapped_column(Float, nullable=True, comment="销售费用")
    less_gerl_admin_exp: Mapped[float | None] = mapped_column(Float, nullable=True, comment="管理费用")
    less_fin_exp: Mapped[float | None] = mapped_column(Float, nullable=True, comment="财务费用")
    oper_profit: Mapped[float | None] = mapped_column(Float, nullable=True, comment="营业利润")
    tot_profit: Mapped[float | None] = mapped_column(Float, nullable=True, comment="利润总额")
...
class TopShareholder(Base, SystemFieldsMixin):
    ...
    s_holder_name: Mapped[str] = mapped_column(String(256), nullable=False, comment="股东名称")
    s_holder_aname: Mapped[str | None] = mapped_column(
        String(256), nullable=True, comment="股东别名（用于实体对齐）"
    )
    s_holder_pct: Mapped[float | None] = mapped_column(Float, nullable=True, comment="持股比例 (%)")
    s_holder_quantity: Mapped[float | None] = mapped_column(Float, nullable=True, comment="持股数量")
    ...
    report_period: Mapped[str | None] = mapped_column(String(10), nullable=True, comment="报告期")
...
class Announcement(Base, SystemFieldsMixin):
    ...
    ann_dt: Mapped[str | None] = mapped_column(String(10), nullable=True, comment="公告日期")
    n_info_title: Mapped[str] = mapped_column(String(512), nullable=False, comment="公告标题")
    ...
    source_uri: Mapped[str | None] = mapped_column(String(1024), nullable=True, comment="来源 URI")
...
class ResearchReport(Base, SystemFieldsMixin):
    ...
    sec_code: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="证券代码")
    exchange_code: Mapped[str | None] = mapped_column(
        String(16), nullable=True, comment="交易所代码"
    )
    sec_name: Mapped[str | None] = mapped_column(String(128), nullable=True, comment="证券简称")
    org_name: Mapped[str | None] = mapped_column(String(256), nullable=True, comment="研究机构")
    title: Mapped[str] = mapped_column(String(512), nullable=False, comment="研报标题")
    publish_date: Mapped[str | None] = mapped_column(String(10), nullable=True, comment="发布日期")
    abstract: Mapped[str | None] = mapped_column(Text, nullable=True, comment="摘要/核心观点")
    rating_org: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="原始评级")
...
class ConversationSession(Base):
    ...
    user_id: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="用户 ID")
...
class ConversationTurn(Base):
    ...
    session_id: Mapped[str] = mapped_column(
        ...
        nullable=False, index=True, comment="所属会话 ID",
    )
    ...
    summary: Mapped[str | None] = mapped_column(Text, nullable=True, comment="轮次摘要 (用于记忆)")
    trace_id: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="追踪 ID")
    module_status: Mapped[dict | None] = mapped_column(JSON, nullable=True, comment="各模块执行状态")
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), default=_utcnow, comment="创建时间"
    )
...
class RuleDefinition(Base):
    ...
    rule_name: Mapped[str] = mapped_column(String(256), nullable=False, comment="规则名称")
    ...
    formula: Mapped[str | None] = mapped_column(Text, nullable=True, comment="计算公式/逻辑描述")
    threshold: Mapped[dict | None] = mapped_column(JSON, nullable=True, comment="阈值配置 (JSON)")
    severity: Mapped[str] = mapped_column(
        String(16), default="medium", comment="默认严重程度: low/medium/high/critical"
    )
    version: Mapped[str] = mapped_column(String(32), default="1.0.0", comment="规则版本")
...
class RuleEvaluation(Base):
    ...
    rule_id: Mapped[str] = mapped_column(
        ...
        nullable=False, index=True, comment="规则 ID",
    )
    wind_code: Mapped[str] = mapped_column(
    ...
    detail: Mapped[dict | None] = mapped_column(JSON, nullable=True, comment="评估详情 (JSON)")
...
class EvidenceRef(Base):
    ...
    source_record_id: Mapped[str] = mapped_column(String(256), nullable=False, comment="来源记录 ID")
    company_code: Mapped[str | None] = mapped_column(
    ...
    period: Mapped[str | None] = mapped_column(String(10), nullable=True, comment="数据期间")
    value: Mapped[str | None] = mapped_column(String(256), nullable=True, comment="字段值")
    ...
    source_uri: Mapped[str | None] = mapped_column(String(1024), nullable=True, comment="来源 URI")
    source_excerpt: Mapped[str | None] = mapped_column(Text, nullable=True, comment="来源摘录")
...
class Claim(Base):
    ...
    rule_id: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="关联规则 ID")
    ...
    limitations: Mapped[list | None] = mapped_column(JSON, nullable=True, comment="局限性说明")
...
class RiskAssessment(Base):
    ...
    overall_score: Mapped[float | None] = mapped_column(Float, nullable=True, comment="综合风险 0-1")
    financial_score: Mapped[float | None] = mapped_column(Float, nullable=True, comment="财务风险 0-1")
    ownership_score: Mapped[float | None] = mapped_column(Float, nullable=True, comment="股权风险 0-1")
    sentiment_score: Mapped[float | None] = mapped_column(Float, nullable=True, comment="舆情风险 0-1")
    level: Mapped[str] = mapped_column(
        String(16), default="low", comment="风险等级: none/low/medium/high/critical"
    )
    risk_factors: Mapped[dict | None] = mapped_column(JSON, nullable=True, comment="风险因子详情 (JSON)")
    rule_version: Mapped[str] = mapped_column(String(32), comment="使用的规则版本")
